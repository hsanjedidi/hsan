          ...
          return Column(
            children: [
              ...
              StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection("places").orderBy("index").snapshots(),
                  //stream: FirebaseFirestore.instance.collection("places").orderBy("index").snapshots(),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                    // print('### snapshot.hasData ${snapshot.data!.docs.length}');
                      avai = 0;
                      for (var i = 0; i < snapshot.data!.docs.length; i++) {
                        if (snapshot.data!.docs[i].get("status")) {
                            avai += 1;
                        }
                      }
                     // print('##available places = $avai');
                      ...
                      return Padding(
                        ...
                        child: Column(
                          children: [
                            /// nombre de place disponibl
                             Text(
                              'nombre de place disponible: $avai/${snapshot.data!.docs.length}',
                              style: TextStyle(
                                fontSize: 20,
                                color: AppColors.principalColor,
                              ),
                                            ...
                                            child: ListView.builder(
                                                ...
                                                itemBuilder: (context, index) {
                                                  return Padding(
                                                    ...
                                                    child: Container(
                                                      decoration: BoxDecoration(
                                                          color: snapshot.data!.docs[index].get("status") ? Colors.grey : Colors.white,
                                            ...
                                            child: ListView.builder(
                                                ...
                                                itemBuilder: (context, index2) {
                                                  return Padding(
                                                    ...
                                                    child: Container(
                                                      decoration: BoxDecoration(
                                                          color: snapshot.data!.docs[index2 + 4].get("status") ? Colors.grey : Colors.white,
                                                          borderRadius: BorderRadius.circular(5)),
                            ...
                            isHidden: [].contains(index),
                                  ...
                                  //         padding: const EdgeInsets.all(8.0),
                                  //         child: Container(
                                  //           decoration: BoxDecoration(color: AppColors.principalColor, borderRadius: BorderRadius.circular(5)),
                                  //           height: widget.h * 0.037,
                                  //           width: widget.w * 0.08,
                                  //         ),
                                  //       )
